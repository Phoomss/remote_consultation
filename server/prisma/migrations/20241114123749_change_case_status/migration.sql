/*
  ...
  - The values [succeed,accepted,notAccepting] on the enum `cases_case_status` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterTable
ALTER TABLE `cases` MODIFY `case_status` ENUM('completed', 'accepting') NOT NULL,
    MODIFY `createdAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(3);
